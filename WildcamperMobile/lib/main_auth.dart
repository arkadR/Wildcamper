...
class _MyAppState extends State<MyApp> {
  ...
  final String _clientId = 'wildcampermobile';
  final String _redirectUrl = 'com.arkadr.wildcamper.io:/auth';
  final String _issuer = 'https://192.168.1.27:32768';
  final String _discoveryUrl =
      'https://192.168.1.27:32768/.well-known/openid-configuration';
  ...
  final AuthorizationServiceConfiguration _serviceConfiguration =
      AuthorizationServiceConfiguration(
          'https://192.168.1.27:32768/connect/authorize',
          'https://192.168.1.27:32768/connect/token');
  ...
  Future<void> _testApi(TokenResponse response) async {
    final http.Response httpResponse = await http.get(
        'https://192.168.1.27:32768/api/test',
